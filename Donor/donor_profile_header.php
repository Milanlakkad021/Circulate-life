	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li class="nav-item"><a class="nav-link" href="donor_personal_details.php"><i class="lnr lnr-home"></i>Personal Details</a></li>
						<li class="nav-item"><a class="nav-link" href="donor_change_password.php"><i class="lnr lnr-drop"></i>Change Password</a></li>
					</ul>
				</nav>
			</div>
		</div>
